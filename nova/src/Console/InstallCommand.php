...
class InstallCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->comment('Generating Category Resource...');
        $this->callSilent('nova:resource', ['name' => 'Category']);
        copy($this->resolveStubPath('/stubs/nova/user-resource.stub'), app_path('Nova/Category.php'));
    ...
    protected function setAppNamespace()
    {
        ...
        $this->setAppNamespaceOn(app_path('Nova/Category.php'), $namespace);
