...
class AuthenticationTest extends IntegrationTest
{
    ...
    //     config(['auth.providers.users.model' => Category::class]);
    ...
    //     $this->assertNotNull(Category::$passwordResetToken);
    //     $response->assertStatus(302);
    //     $response->assertSessionHas('status', 'We have e-mailed your password reset link!');

    //     // Reset Password...
    //     $response = $this->withExceptionHandling()
    //                     ->get('/nova/password/reset/'.Category::$passwordResetToken);

    //     $response->assertStatus(200);

    //     $response = $this->withExceptionHandling()
    //                     ->post('/nova/password/reset', [
    //                         'token' => Category::$passwordResetToken,
    //                         'email' => 'taylor@laravel.com',
    //                         'password' => 'taylor',
